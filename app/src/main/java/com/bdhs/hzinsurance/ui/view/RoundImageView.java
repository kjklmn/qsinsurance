...
public class RoundImageView extends ImageView {
    ...
    private static final int BODER_width_DEFAULT = 3;
    /**
     * 圆角的大小
     */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (type == TYPE_ROUND) {
            ...
            drawCircleBorder(canvas, 0, 0);
            canvas.drawCircle(mRadius, mRadius, mRadius - boderWith, mPaint);
        }
    }
    ...
    private void drawCircleBorder(Canvas canvas, int radius, int color) {
        ...
        /* 设置paint的外框宽度 */
        paint.setStrokeWidth((float) boderWith);
        canvas.drawCircle(mRadius, mRadius, mRadius - boderWith, paint);
    }
...
//        type = array.getInt(R.styleable.RoundImageView_type, TYPE_ROUND);
        ...
        boderWith = array.getDimensionPixelSize(R.styleable.RoundImageView_borderWidth, BODER_width_DEFAULT);
        array.recycle();
    }
    ...
    private void setUpShader() {
        ...
        float scale = 1.0f;
        int viewwidth = getWidth() - boderWith;
        int viewheight = getHeight() - boderWith;
