...
//import com.cjym.yunmabao.utils.NetWorkUtils;
...
import com.bdhs.hzinsurance.utils.NetWorkUtils;
...
////        builder.addHeader("token",MainApplication.getInstance().getToken());
...
//        builder.addHeader("token",MainApplication.getInstance().getToken());
    ...
    public ApiRetrofit() {
        //cache url
        File httpCacheDirectory = new File(MainApplication.getInstance().getContext().getCacheDir(), "responses");
